...
### Overview Video
This rather long and slightly outdated video gives an idea of the features of the toolset, it does not show how to use the toolset.
...
### Houdini Nodes
The toolset is in the form of Houdini Digital Assets which take the form of a "Node" in Houdini. These nodes are the building blocks that allow you to convert Houdini
creations into something usable in TaleSpire.
- [Node Reference](https://github.com/Baldrax/Houdini_TaleSpire_Terrain_Generation_Toolset/wiki/Node-Reference)
...
### Examples
The toolset comes with several annotized example files so you can see hands-on how some of these tools are utilized.
- [Example Files](https://github.com/Baldrax/Houdini_TaleSpire_Terrain_Generation_Toolset/wiki/Example-Files)
