...
If you are only using the mod to create maps it is probably easier to use RPCPlugin since I believe Chat Service may
require all connected users to have the mods.
